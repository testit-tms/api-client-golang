...
type _TestResultModel TestResultModel
...
func (o *TestResultModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestResultModel := _TestResultModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestResultModel)

	if err != nil {
		return err
	}

	*o = TestResultModel(varTestResultModel)
