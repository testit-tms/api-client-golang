...
// checks if the TagsFilterModelCreatedDate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagsFilterModelCreatedDate{}

// TagsFilterModelCreatedDate Specifies a tag range of creation date to search for
type TagsFilterModelCreatedDate struct {
...
func NewTagsFilterModelCreatedDate() *TagsFilterModelCreatedDate {
	this := TagsFilterModelCreatedDate{}
	return &this
}
...
func (o *TagsFilterModelCreatedDate) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *TagsFilterModelCreatedDate) SetToNil() {
	o.To.Set(nil)
}
...
func (o TagsFilterModelCreatedDate) MarshalJSON() ([]byte, error) {
...
func (o TagsFilterModelCreatedDate) ToMap() (map[string]interface{}, error) {
...
type NullableTagsFilterModelCreatedDate struct {
	value *TagsFilterModelCreatedDate
	isSet bool
}

func (v NullableTagsFilterModelCreatedDate) Get() *TagsFilterModelCreatedDate {
	return v.value
}

func (v *NullableTagsFilterModelCreatedDate) Set(val *TagsFilterModelCreatedDate) {
	v.value = val
	v.isSet = true
}

func (v NullableTagsFilterModelCreatedDate) IsSet() bool {
	return v.isSet
}

func (v *NullableTagsFilterModelCreatedDate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagsFilterModelCreatedDate(val *TagsFilterModelCreatedDate) *NullableTagsFilterModelCreatedDate {
	return &NullableTagsFilterModelCreatedDate{value: val, isSet: true}
}

func (v NullableTagsFilterModelCreatedDate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagsFilterModelCreatedDate) UnmarshalJSON(src []byte) error {
	v.isSet = true
