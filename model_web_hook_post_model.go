...
type _WebHookPostModel WebHookPostModel
...
func (o *WebHookPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varWebHookPostModel := _WebHookPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebHookPostModel)

	if err != nil {
		return err
	}

	*o = WebHookPostModel(varWebHookPostModel)
