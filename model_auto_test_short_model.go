...
type _AutoTestShortModel AutoTestShortModel
...
func (o *AutoTestShortModel) UnmarshalJSON(data []byte) (err error) {
	...
	varAutoTestShortModel := _AutoTestShortModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAutoTestShortModel)

	if err != nil {
		return err
	}

	*o = AutoTestShortModel(varAutoTestShortModel)
