...
type _TestRunV2PostShortModel TestRunV2PostShortModel
...
func (o *TestRunV2PostShortModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestRunV2PostShortModel := _TestRunV2PostShortModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestRunV2PostShortModel)

	if err != nil {
		return err
	}

	*o = TestRunV2PostShortModel(varTestRunV2PostShortModel)
