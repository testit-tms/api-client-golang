...
`func (o *WorkItemFilterModel) SetSourceTypesNil(b bool)`

 SetSourceTypesNil sets the value for SourceTypes to be an explicit nil

### UnsetSourceTypes
`func (o *WorkItemFilterModel) UnsetSourceTypes()`

UnsetSourceTypes ensures that no value is present for SourceTypes, not even an explicit nil
### GetTypes

`func (o *WorkItemFilterModel) GetTypes() []WorkItemTypeModel`

GetTypes returns the Types field if non-nil, zero value otherwise.

### GetTypesOk

`func (o *WorkItemFilterModel) GetTypesOk() (*[]WorkItemTypeModel, bool)`
...
`func (o *WorkItemFilterModel) SetTypes(v []WorkItemTypeModel)`
...
`func (o *WorkItemFilterModel) GetDuration() Int64RangeSelectorModel`

GetDuration returns the Duration field if non-nil, zero value otherwise.

### GetDurationOk

`func (o *WorkItemFilterModel) GetDurationOk() (*Int64RangeSelectorModel, bool)`
...
`func (o *WorkItemFilterModel) SetDuration(v Int64RangeSelectorModel)`
...
`func (o *WorkItemFilterModel) SetExcludeTagsNil(b bool)`

 SetExcludeTagsNil sets the value for ExcludeTags to be an explicit nil

### UnsetExcludeTags
`func (o *WorkItemFilterModel) UnsetExcludeTags()`
