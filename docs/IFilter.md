...
`func NewIFilter(filters []IFilter, operator CollectionOperator, value JsonElement, field string, filter IFilter, ) *IFilter`
...
`func (o *IFilter) GetValue() JsonElement`

GetValue returns the Value field if non-nil, zero value otherwise.

### GetValueOk

`func (o *IFilter) GetValueOk() (*JsonElement, bool)`
...
`func (o *IFilter) SetValue(v JsonElement)`
