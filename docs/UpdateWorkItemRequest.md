...
`func NewUpdateWorkItemRequest(attachments []AttachmentPutModel, id string, state WorkItemStates, priority WorkItemPriorityModel, steps []StepPutModel, preconditionSteps []StepPutModel, postconditionSteps []StepPutModel, attributes map[string]interface{}, tags []TagShortModel, links []LinkPutModel, name string, ) *UpdateWorkItemRequest`
...
`func (o *UpdateWorkItemRequest) HasSectionId() bool`
...
`func (o *UpdateWorkItemRequest) HasDuration() bool`
