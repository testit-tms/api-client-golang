...
**LastTestResultStatusCode** | Pointer to **NullableString** | Specifies an autotest status code of the last test result to search for | [optional] 
...
`func (o *AutoTestFilterApiModel) SetLastTestResultStatusCodeNil(b bool)`
