...
`func (o *WorkItemLocalFilterModel) GetDuration() Int64RangeSelectorModel`

GetDuration returns the Duration field if non-nil, zero value otherwise.

### GetDurationOk

`func (o *WorkItemLocalFilterModel) GetDurationOk() (*Int64RangeSelectorModel, bool)`
...
`func (o *WorkItemLocalFilterModel) SetDuration(v Int64RangeSelectorModel)`
