...
**Analytic** | Pointer to [**TestRunModelAnalytic**](TestRunModelAnalytic.md) |  | [optional] 
...
**LaunchSource** | Pointer to **string** |  | [optional] 
...
`func (o *TestRunModel) SetTestPlanNil(b bool)`
