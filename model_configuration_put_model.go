...
type _ConfigurationPutModel ConfigurationPutModel
...
func (o *ConfigurationPutModel) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigurationPutModel := _ConfigurationPutModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigurationPutModel)

	if err != nil {
		return err
	}

	*o = ConfigurationPutModel(varConfigurationPutModel)
