...
type _TestRunFillByAutoTestsPostModel TestRunFillByAutoTestsPostModel
...
func (o *TestRunFillByAutoTestsPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestRunFillByAutoTestsPostModel := _TestRunFillByAutoTestsPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestRunFillByAutoTestsPostModel)

	if err != nil {
		return err
	}

	*o = TestRunFillByAutoTestsPostModel(varTestRunFillByAutoTestsPostModel)
