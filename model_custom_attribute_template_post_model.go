...
type _CustomAttributeTemplatePostModel CustomAttributeTemplatePostModel
...
func (o *CustomAttributeTemplatePostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomAttributeTemplatePostModel := _CustomAttributeTemplatePostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomAttributeTemplatePostModel)

	if err != nil {
		return err
	}

	*o = CustomAttributeTemplatePostModel(varCustomAttributeTemplatePostModel)
