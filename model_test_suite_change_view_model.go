...
type _TestSuiteChangeViewModel TestSuiteChangeViewModel
...
func (o *TestSuiteChangeViewModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestSuiteChangeViewModel := _TestSuiteChangeViewModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestSuiteChangeViewModel)

	if err != nil {
		return err
	}

	*o = TestSuiteChangeViewModel(varTestSuiteChangeViewModel)
