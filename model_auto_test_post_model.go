...
type _AutoTestPostModel AutoTestPostModel
...
func (o *AutoTestPostModel) SetExternalKeyNil() {
...
func (o *AutoTestPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varAutoTestPostModel := _AutoTestPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAutoTestPostModel)

	if err != nil {
		return err
	}

	*o = AutoTestPostModel(varAutoTestPostModel)
