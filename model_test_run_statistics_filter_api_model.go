...
// checks if the TestRunStatisticsFilterApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestRunStatisticsFilterApiModel{}

// TestRunStatisticsFilterApiModel struct for TestRunStatisticsFilterApiModel
type TestRunStatisticsFilterApiModel struct {
...
func NewTestRunStatisticsFilterApiModel() *TestRunStatisticsFilterApiModel {
	this := TestRunStatisticsFilterApiModel{}
	return &this
}
...
func (o *TestRunStatisticsFilterApiModel) SetNamespaceNil() {
	o.Namespace.Set(nil)
}
...
func (o *TestRunStatisticsFilterApiModel) SetClassNameNil() {
	o.ClassName.Set(nil)
}
...
func (o TestRunStatisticsFilterApiModel) MarshalJSON() ([]byte, error) {
...
func (o TestRunStatisticsFilterApiModel) ToMap() (map[string]interface{}, error) {
...
type NullableTestRunStatisticsFilterApiModel struct {
	value *TestRunStatisticsFilterApiModel
	isSet bool
}

func (v NullableTestRunStatisticsFilterApiModel) Get() *TestRunStatisticsFilterApiModel {
	return v.value
}

func (v *NullableTestRunStatisticsFilterApiModel) Set(val *TestRunStatisticsFilterApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableTestRunStatisticsFilterApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableTestRunStatisticsFilterApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestRunStatisticsFilterApiModel(val *TestRunStatisticsFilterApiModel) *NullableTestRunStatisticsFilterApiModel {
	return &NullableTestRunStatisticsFilterApiModel{value: val, isSet: true}
}

func (v NullableTestRunStatisticsFilterApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestRunStatisticsFilterApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
