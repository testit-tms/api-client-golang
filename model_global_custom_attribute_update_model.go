...
type _GlobalCustomAttributeUpdateModel GlobalCustomAttributeUpdateModel
...
func (o *GlobalCustomAttributeUpdateModel) UnmarshalJSON(data []byte) (err error) {
	...
	varGlobalCustomAttributeUpdateModel := _GlobalCustomAttributeUpdateModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGlobalCustomAttributeUpdateModel)

	if err != nil {
		return err
	}

	*o = GlobalCustomAttributeUpdateModel(varGlobalCustomAttributeUpdateModel)
