...
// checks if the ConfigurationFilterApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigurationFilterApiModel{}

// ConfigurationFilterApiModel struct for ConfigurationFilterApiModel
type ConfigurationFilterApiModel struct {
...
func NewConfigurationFilterApiModel() *ConfigurationFilterApiModel {
	this := ConfigurationFilterApiModel{}
	return &this
}
...
func (o *ConfigurationFilterApiModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ConfigurationFilterApiModel) SetIsDeletedNil() {
	o.IsDeleted.Set(nil)
}
...
func (o ConfigurationFilterApiModel) MarshalJSON() ([]byte, error) {
...
func (o ConfigurationFilterApiModel) ToMap() (map[string]interface{}, error) {
...
type NullableConfigurationFilterApiModel struct {
	value *ConfigurationFilterApiModel
	isSet bool
}

func (v NullableConfigurationFilterApiModel) Get() *ConfigurationFilterApiModel {
	return v.value
}

func (v *NullableConfigurationFilterApiModel) Set(val *ConfigurationFilterApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigurationFilterApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigurationFilterApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigurationFilterApiModel(val *ConfigurationFilterApiModel) *NullableConfigurationFilterApiModel {
	return &NullableConfigurationFilterApiModel{value: val, isSet: true}
}

func (v NullableConfigurationFilterApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigurationFilterApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
