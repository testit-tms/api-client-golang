...
type _AttachmentChangeViewModel AttachmentChangeViewModel
...
func (o *AttachmentChangeViewModel) UnmarshalJSON(data []byte) (err error) {
	...
	varAttachmentChangeViewModel := _AttachmentChangeViewModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAttachmentChangeViewModel)

	if err != nil {
		return err
	}

	*o = AttachmentChangeViewModel(varAttachmentChangeViewModel)
