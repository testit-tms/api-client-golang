...
type _SharedStepReferenceModel SharedStepReferenceModel
...
func (o *SharedStepReferenceModel) UnmarshalJSON(data []byte) (err error) {
	...
	varSharedStepReferenceModel := _SharedStepReferenceModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSharedStepReferenceModel)

	if err != nil {
		return err
	}

	*o = SharedStepReferenceModel(varSharedStepReferenceModel)
