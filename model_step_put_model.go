...
type _StepPutModel StepPutModel
...
func (o *StepPutModel) UnmarshalJSON(data []byte) (err error) {
	...
	varStepPutModel := _StepPutModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStepPutModel)

	if err != nil {
		return err
	}

	*o = StepPutModel(varStepPutModel)
