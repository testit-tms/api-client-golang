...
type _TagPostModel TagPostModel
...
func (o *TagPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTagPostModel := _TagPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTagPostModel)

	if err != nil {
		return err
	}

	*o = TagPostModel(varTagPostModel)
