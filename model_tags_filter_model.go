...
// checks if the TagsFilterModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagsFilterModel{}

// TagsFilterModel struct for TagsFilterModel
...
func (o *TagsFilterModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *TagsFilterModel) SetCreatedDateNil() {
...
func (o TagsFilterModel) MarshalJSON() ([]byte, error) {
...
func (o TagsFilterModel) ToMap() (map[string]interface{}, error) {
...
type NullableTagsFilterModel struct {
	value *TagsFilterModel
	isSet bool
}

func (v NullableTagsFilterModel) Get() *TagsFilterModel {
	return v.value
}

func (v *NullableTagsFilterModel) Set(val *TagsFilterModel) {
	v.value = val
	v.isSet = true
}

func (v NullableTagsFilterModel) IsSet() bool {
	return v.isSet
}

func (v *NullableTagsFilterModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagsFilterModel(val *TagsFilterModel) *NullableTagsFilterModel {
	return &NullableTagsFilterModel{value: val, isSet: true}
}

func (v NullableTagsFilterModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagsFilterModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
