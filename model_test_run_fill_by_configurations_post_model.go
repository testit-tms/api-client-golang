...
type _TestRunFillByConfigurationsPostModel TestRunFillByConfigurationsPostModel
...
func (o *TestRunFillByConfigurationsPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestRunFillByConfigurationsPostModel := _TestRunFillByConfigurationsPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestRunFillByConfigurationsPostModel)

	if err != nil {
		return err
	}

	*o = TestRunFillByConfigurationsPostModel(varTestRunFillByConfigurationsPostModel)
