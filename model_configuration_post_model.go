...
type _ConfigurationPostModel ConfigurationPostModel
...
func (o *ConfigurationPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigurationPostModel := _ConfigurationPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigurationPostModel)

	if err != nil {
		return err
	}

	*o = ConfigurationPostModel(varConfigurationPostModel)
