...
type _TestRunV2PutModel TestRunV2PutModel
...
func (o *TestRunV2PutModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestRunV2PutModel := _TestRunV2PutModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestRunV2PutModel)

	if err != nil {
		return err
	}

	*o = TestRunV2PutModel(varTestRunV2PutModel)
