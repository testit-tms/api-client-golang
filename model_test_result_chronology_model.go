...
type _TestResultChronologyModel TestResultChronologyModel
...
func (o *TestResultChronologyModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestResultChronologyModel := _TestResultChronologyModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestResultChronologyModel)

	if err != nil {
		return err
	}

	*o = TestResultChronologyModel(varTestResultChronologyModel)
