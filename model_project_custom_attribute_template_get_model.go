...
type _ProjectCustomAttributeTemplateGetModel ProjectCustomAttributeTemplateGetModel
...
func (o *ProjectCustomAttributeTemplateGetModel) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectCustomAttributeTemplateGetModel := _ProjectCustomAttributeTemplateGetModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProjectCustomAttributeTemplateGetModel)

	if err != nil {
		return err
	}

	*o = ProjectCustomAttributeTemplateGetModel(varProjectCustomAttributeTemplateGetModel)
