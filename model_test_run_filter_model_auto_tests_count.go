...
// checks if the TestRunFilterModelAutoTestsCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestRunFilterModelAutoTestsCount{}

// TestRunFilterModelAutoTestsCount Number of autoTests run in the test run
type TestRunFilterModelAutoTestsCount struct {
...
func NewTestRunFilterModelAutoTestsCount() *TestRunFilterModelAutoTestsCount {
	this := TestRunFilterModelAutoTestsCount{}
	return &this
}
...
func (o *TestRunFilterModelAutoTestsCount) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *TestRunFilterModelAutoTestsCount) SetToNil() {
	o.To.Set(nil)
}
...
func (o TestRunFilterModelAutoTestsCount) MarshalJSON() ([]byte, error) {
...
func (o TestRunFilterModelAutoTestsCount) ToMap() (map[string]interface{}, error) {
...
type NullableTestRunFilterModelAutoTestsCount struct {
	value *TestRunFilterModelAutoTestsCount
	isSet bool
}

func (v NullableTestRunFilterModelAutoTestsCount) Get() *TestRunFilterModelAutoTestsCount {
	return v.value
}

func (v *NullableTestRunFilterModelAutoTestsCount) Set(val *TestRunFilterModelAutoTestsCount) {
	v.value = val
	v.isSet = true
}

func (v NullableTestRunFilterModelAutoTestsCount) IsSet() bool {
	return v.isSet
}

func (v *NullableTestRunFilterModelAutoTestsCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestRunFilterModelAutoTestsCount(val *TestRunFilterModelAutoTestsCount) *NullableTestRunFilterModelAutoTestsCount {
	return &NullableTestRunFilterModelAutoTestsCount{value: val, isSet: true}
}

func (v NullableTestRunFilterModelAutoTestsCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestRunFilterModelAutoTestsCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
