...
type _CustomAttributeTemplatePutModel CustomAttributeTemplatePutModel
...
func (o *CustomAttributeTemplatePutModel) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomAttributeTemplatePutModel := _CustomAttributeTemplatePutModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomAttributeTemplatePutModel)

	if err != nil {
		return err
	}

	*o = CustomAttributeTemplatePutModel(varCustomAttributeTemplatePutModel)
