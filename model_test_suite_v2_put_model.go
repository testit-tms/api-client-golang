...
type _TestSuiteV2PutModel TestSuiteV2PutModel
...
func (o *TestSuiteV2PutModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestSuiteV2PutModel := _TestSuiteV2PutModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestSuiteV2PutModel)

	if err != nil {
		return err
	}

	*o = TestSuiteV2PutModel(varTestSuiteV2PutModel)
