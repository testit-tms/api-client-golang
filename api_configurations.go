...
func (r ApiApiV2ConfigurationsPurgeBulkPostRequest) Execute() (int32, *http.Response, error) {
...
// Execute executes the request
//  @return int32
func (a *ConfigurationsAPIService) ApiV2ConfigurationsPurgeBulkPostExecute(r ApiApiV2ConfigurationsPurgeBulkPostRequest) (int32, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
