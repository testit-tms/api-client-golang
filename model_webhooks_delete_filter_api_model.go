...
// checks if the WebhooksDeleteFilterApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhooksDeleteFilterApiModel{}

// WebhooksDeleteFilterApiModel struct for WebhooksDeleteFilterApiModel
type WebhooksDeleteFilterApiModel struct {
...
func NewWebhooksDeleteFilterApiModel() *WebhooksDeleteFilterApiModel {
	this := WebhooksDeleteFilterApiModel{}
	return &this
}
...
func (o *WebhooksDeleteFilterApiModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *WebhooksDeleteFilterApiModel) SetIsEnabledNil() {
	o.IsEnabled.Set(nil)
}
...
func (o WebhooksDeleteFilterApiModel) MarshalJSON() ([]byte, error) {
...
func (o WebhooksDeleteFilterApiModel) ToMap() (map[string]interface{}, error) {
...
type NullableWebhooksDeleteFilterApiModel struct {
	value *WebhooksDeleteFilterApiModel
	isSet bool
}

func (v NullableWebhooksDeleteFilterApiModel) Get() *WebhooksDeleteFilterApiModel {
	return v.value
}

func (v *NullableWebhooksDeleteFilterApiModel) Set(val *WebhooksDeleteFilterApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhooksDeleteFilterApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhooksDeleteFilterApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhooksDeleteFilterApiModel(val *WebhooksDeleteFilterApiModel) *NullableWebhooksDeleteFilterApiModel {
	return &NullableWebhooksDeleteFilterApiModel{value: val, isSet: true}
}

func (v NullableWebhooksDeleteFilterApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhooksDeleteFilterApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
