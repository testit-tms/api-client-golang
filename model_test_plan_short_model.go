...
type _TestPlanShortModel TestPlanShortModel
...
func (o *TestPlanShortModel) UnmarshalJSON(data []byte) (err error) {
	...
	varTestPlanShortModel := _TestPlanShortModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestPlanShortModel)

	if err != nil {
		return err
	}

	*o = TestPlanShortModel(varTestPlanShortModel)
