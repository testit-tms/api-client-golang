...
// checks if the AutotestsSelectModelFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutotestsSelectModelFilter{}

// AutotestsSelectModelFilter Object containing different filters to adjust search
type AutotestsSelectModelFilter struct {
...
func NewAutotestsSelectModelFilter() *AutotestsSelectModelFilter {
	this := AutotestsSelectModelFilter{}
	return &this
}
...
func (o *AutotestsSelectModelFilter) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *AutotestsSelectModelFilter) SetIsFlakyNil() {
	o.IsFlaky.Set(nil)
}
...
func (o *AutotestsSelectModelFilter) SetMustBeApprovedNil() {
...
func (o *AutotestsSelectModelFilter) SetStabilityPercentageNil() {
...
func (o *AutotestsSelectModelFilter) SetCreatedDateNil() {
...
func (o *AutotestsSelectModelFilter) SetModifiedDateNil() {
...
func (o *AutotestsSelectModelFilter) SetIsDeletedNil() {
	o.IsDeleted.Set(nil)
}
...
func (o *AutotestsSelectModelFilter) SetNamespaceNil() {
	o.Namespace.Set(nil)
}
...
func (o *AutotestsSelectModelFilter) SetIsEmptyNamespaceNil() {
...
func (o *AutotestsSelectModelFilter) SetClassNameNil() {
	o.ClassName.Set(nil)
}
...
func (o *AutotestsSelectModelFilter) SetIsEmptyClassNameNil() {
...
func (o *AutotestsSelectModelFilter) SetLastTestResultOutcomeNil() {
...
func (o AutotestsSelectModelFilter) ToMap() (map[string]interface{}, error) {
...
type NullableAutotestsSelectModelFilter struct {
	value *AutotestsSelectModelFilter
	isSet bool
}

func (v NullableAutotestsSelectModelFilter) Get() *AutotestsSelectModelFilter {
	return v.value
}

func (v *NullableAutotestsSelectModelFilter) Set(val *AutotestsSelectModelFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAutotestsSelectModelFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAutotestsSelectModelFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutotestsSelectModelFilter(val *AutotestsSelectModelFilter) *NullableAutotestsSelectModelFilter {
	return &NullableAutotestsSelectModelFilter{value: val, isSet: true}
}

func (v NullableAutotestsSelectModelFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutotestsSelectModelFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
