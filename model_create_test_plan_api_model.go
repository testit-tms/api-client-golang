...
// checks if the CreateTestPlanApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTestPlanApiModel{}
...
type CreateTestPlanApiModel struct {
	...
	TestSuite NullableTestSuiteTestPlanApiModel `json:"testSuite,omitempty"`
}

type _CreateTestPlanApiModel CreateTestPlanApiModel
...
func (o *CreateTestPlanApiModel) SetStartDateNil() {
	o.StartDate.Set(nil)
}
...
func (o *CreateTestPlanApiModel) SetEndDateNil() {
	o.EndDate.Set(nil)
}
...
func (o *CreateTestPlanApiModel) SetDescriptionNil() {
...
func (o *CreateTestPlanApiModel) SetBuildNil() {
	o.Build.Set(nil)
}
...
func (o *CreateTestPlanApiModel) SetProductNameNil() {
...
func (o *CreateTestPlanApiModel) SetHasAutomaticDurationTimerNil() {
...
func (o *CreateTestPlanApiModel) GetTestSuite() TestSuiteTestPlanApiModel {
	if o == nil || IsNil(o.TestSuite.Get()) {
		var ret TestSuiteTestPlanApiModel
		return ret
	}
...
// SetTestSuite gets a reference to the given NullableTestSuiteTestPlanApiModel and assigns it to the TestSuite field.
...
func (o *CreateTestPlanApiModel) SetTestSuiteNil() {
	o.TestSuite.Set(nil)
}
...
func (o CreateTestPlanApiModel) MarshalJSON() ([]byte, error) {
...
func (o CreateTestPlanApiModel) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTestPlanApiModel) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTestPlanApiModel := _CreateTestPlanApiModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTestPlanApiModel)

	if err != nil {
		return err
	}

	*o = CreateTestPlanApiModel(varCreateTestPlanApiModel)

	return err
}

type NullableCreateTestPlanApiModel struct {
	value *CreateTestPlanApiModel
	isSet bool
}

func (v NullableCreateTestPlanApiModel) Get() *CreateTestPlanApiModel {
	return v.value
}

func (v *NullableCreateTestPlanApiModel) Set(val *CreateTestPlanApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTestPlanApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTestPlanApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTestPlanApiModel(val *CreateTestPlanApiModel) *NullableCreateTestPlanApiModel {
	return &NullableCreateTestPlanApiModel{value: val, isSet: true}
}

func (v NullableCreateTestPlanApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTestPlanApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
