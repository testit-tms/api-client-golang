...
func (r ApiApiV2AttachmentsIdGetRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AttachmentsAPIService) ApiV2AttachmentsIdGetExecute(r ApiApiV2AttachmentsIdGetRequest) (*http.Response, error) {
	var (
...
type ApiApiV2AttachmentsIdMetadataGetRequest struct {
	ctx context.Context
	ApiService *AttachmentsAPIService
	id string
}

func (r ApiApiV2AttachmentsIdMetadataGetRequest) Execute() (*AttachmentModel, *http.Response, error) {
	return r.ApiService.ApiV2AttachmentsIdMetadataGetExecute(r)
}

/*
ApiV2AttachmentsIdMetadataGet Get attachment metadata

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiApiV2AttachmentsIdMetadataGetRequest
*/
func (a *AttachmentsAPIService) ApiV2AttachmentsIdMetadataGet(ctx context.Context, id string) ApiApiV2AttachmentsIdMetadataGetRequest {
	return ApiApiV2AttachmentsIdMetadataGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *AttachmentsAPIService) ApiV2AttachmentsIdMetadataGetExecute(r ApiApiV2AttachmentsIdMetadataGetRequest) (*AttachmentModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttachmentsAPIService.ApiV2AttachmentsIdMetadataGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/attachments/{id}/metadata"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
