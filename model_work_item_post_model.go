...
type _WorkItemPostModel WorkItemPostModel
...
func (o *WorkItemPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkItemPostModel := _WorkItemPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWorkItemPostModel)

	if err != nil {
		return err
	}

	*o = WorkItemPostModel(varWorkItemPostModel)
