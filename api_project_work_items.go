...
type ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest struct {
	ctx context.Context
...
func (r ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest) CreateWorkItemPreviewsApiModel(createWorkItemPreviewsApiModel CreateWorkItemPreviewsApiModel) ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest {
	r.createWorkItemPreviewsApiModel = &createWorkItemPreviewsApiModel
	return r
}

func (r ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.ApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostExecute(r)
}

/*
ApiV2ProjectsProjectIdWorkItemsPreviewsBulkPost Method for ApiV2ProjectsProjectIdWorkItemsPreviewsBulkPost

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId Internal (UUID) or global (integer) identifier
 @return ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest
*/
func (a *ProjectWorkItemsAPIService) ApiV2ProjectsProjectIdWorkItemsPreviewsBulkPost(ctx context.Context, projectId string) ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest {
	return ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
func (a *ProjectWorkItemsAPIService) ApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostExecute(r ApiApiV2ProjectsProjectIdWorkItemsPreviewsBulkPostRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectWorkItemsAPIService.ApiV2ProjectsProjectIdWorkItemsPreviewsBulkPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectId}/work-items/previews/bulk"
	...
	// body params
	localVarPostBody = r.createWorkItemPreviewsApiModel
	if r.ctx != nil {
...
type ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest struct {
	ctx context.Context
	ApiService *ProjectWorkItemsAPIService
	projectId string
...
func (r ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest) GenerateWorkItemPreviewsApiModel(generateWorkItemPreviewsApiModel GenerateWorkItemPreviewsApiModel) ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest {
	r.generateWorkItemPreviewsApiModel = &generateWorkItemPreviewsApiModel
	return r
}

func (r ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest) Execute() (*GenerateWorkItemPreviewsApiResult, *http.Response, error) {
	return r.ApiService.ApiV2ProjectsProjectIdWorkItemsPreviewsPostExecute(r)
}

/*
ApiV2ProjectsProjectIdWorkItemsPreviewsPost Method for ApiV2ProjectsProjectIdWorkItemsPreviewsPost

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId Internal (UUID) or global (integer) identifier
 @return ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest
*/
func (a *ProjectWorkItemsAPIService) ApiV2ProjectsProjectIdWorkItemsPreviewsPost(ctx context.Context, projectId string) ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest {
	return ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
func (a *ProjectWorkItemsAPIService) ApiV2ProjectsProjectIdWorkItemsPreviewsPostExecute(r ApiApiV2ProjectsProjectIdWorkItemsPreviewsPostRequest) (*GenerateWorkItemPreviewsApiResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenerateWorkItemPreviewsApiResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectWorkItemsAPIService.ApiV2ProjectsProjectIdWorkItemsPreviewsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectId}/work-items/previews"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	...
	// body params
	localVarPostBody = r.generateWorkItemPreviewsApiModel
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["PrivateToken"]; ok {
...
type ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest struct {
	ctx context.Context
	ApiService *ProjectWorkItemsAPIService
	projectId string
	workItemId string
...
// Amount of items to be skipped (offset)
func (r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) Skip(skip int32) ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest {
	r.skip = &skip
	return r
}

// Amount of items to be taken (limit)
func (r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) Take(take int32) ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest {
	r.take = &take
	return r
}

// SQL-like  ORDER BY statement (column1 ASC|DESC , column2 ASC|DESC)
func (r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) OrderBy(orderBy string) ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest {
	r.orderBy = &orderBy
	return r
}

// Property name for searching
func (r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) SearchField(searchField string) ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest {
	r.searchField = &searchField
	return r
}

// Value for searching
func (r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) SearchValue(searchValue string) ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest {
	r.searchValue = &searchValue
	return r
}

func (r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) WorkItemSelectApiModel(workItemSelectApiModel WorkItemSelectApiModel) ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest {
	r.workItemSelectApiModel = &workItemSelectApiModel
	return r
}

func (r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) Execute() (*WorkItemIndexApiResult, *http.Response, error) {
	return r.ApiService.ApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostExecute(r)
}
...
*/
func (a *ProjectWorkItemsAPIService) ApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPost(ctx context.Context, projectId string, workItemId string) ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest {
	return ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
func (a *ProjectWorkItemsAPIService) ApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostExecute(r ApiApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPostRequest) (*WorkItemIndexApiResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkItemIndexApiResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectWorkItemsAPIService.ApiV2ProjectsProjectIdWorkItemsSearchWorkItemIdIndexPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectId}/workItems/search/{workItemId}/index"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
