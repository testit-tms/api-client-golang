...
// checks if the WebhooksDeleteFilterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhooksDeleteFilterRequest{}

// WebhooksDeleteFilterRequest struct for WebhooksDeleteFilterRequest
type WebhooksDeleteFilterRequest struct {
...
func NewWebhooksDeleteFilterRequest() *WebhooksDeleteFilterRequest {
	this := WebhooksDeleteFilterRequest{}
	return &this
}
...
func (o *WebhooksDeleteFilterRequest) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *WebhooksDeleteFilterRequest) SetIsEnabledNil() {
	o.IsEnabled.Set(nil)
}
...
func (o WebhooksDeleteFilterRequest) MarshalJSON() ([]byte, error) {
...
func (o WebhooksDeleteFilterRequest) ToMap() (map[string]interface{}, error) {
...
type NullableWebhooksDeleteFilterRequest struct {
	value *WebhooksDeleteFilterRequest
	isSet bool
}

func (v NullableWebhooksDeleteFilterRequest) Get() *WebhooksDeleteFilterRequest {
	return v.value
}

func (v *NullableWebhooksDeleteFilterRequest) Set(val *WebhooksDeleteFilterRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhooksDeleteFilterRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhooksDeleteFilterRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhooksDeleteFilterRequest(val *WebhooksDeleteFilterRequest) *NullableWebhooksDeleteFilterRequest {
	return &NullableWebhooksDeleteFilterRequest{value: val, isSet: true}
}

func (v NullableWebhooksDeleteFilterRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhooksDeleteFilterRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
